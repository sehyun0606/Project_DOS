    ...
    <div class="container2">
        <div class="row mb-4">
            <div class="board-meta2">
                <p><공지 사항>2024-12-24 DOS에서 새로 홈페이지를 단장했습니다.> </p>
            </div>
...
<%--             ${sessionScope.regDate} --%>
        ...
        <div class="board-content-wrapper">
            <div class="board-content">
                <img src="path/to/your/image.jpg" alt="공지사항 이미지" class="img-fluid mt-3">
                <p>
                    <strong><공지사항></strong><br>
                    안녕하세요 최고의 레스토랑 DOS입니다.<br>
                    이번에 새로 홈페이지를 단장했습니다.<br>
                    많은 이용 부탁드립니다.<br>
                </p>
            </div>
        </div>
