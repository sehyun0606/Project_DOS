    ...
    <div class="main-layout">
        ...
        <div class="content">
            ...
            <div class="category-tabs">
                <div class="category-tab active" data-target="category1" onclick="showCategory('category1')">스테이크</div>
                <div class="category-tab" data-target="category2" onclick="showCategory('category2')">파스타</div>
                <div class="category-tab" data-target="category3" onclick="showCategory('category3')">필라프</div>
                <div class="category-tab" data-target="category3" onclick="showCategory('category4')">리조또</div>
            </div>
            ...
            <div class="product-container active" id="category1">
                <div class="product-card">
                    ...
                    <div class="product-name">스테이크</div>
            ...
            <div class="product-container" id="category2">
                <div class="product-card">
                    <div class="product-image">이미지</div>
                    <div class="product-name">파스타</div>
            ...
            <div class="product-container" id="category3">
                <div class="product-card">
                    <div class="product-image">이미지</div>
                    <div class="product-name">필라프</div>
            ...
            <div class="product-container" id="category4">
                <div class="product-card">
                    <div class="product-image">이미지</div>
                    <div class="product-name">리조또</div>
