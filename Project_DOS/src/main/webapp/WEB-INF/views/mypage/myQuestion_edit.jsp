...
<body>
            ...
            <article class="content">
                <div class="container">
                    <div class="table-container">
                        <h2 class="text-center mb-4">문의사항 수정</h2>
                        <form action="UpdateQna" method="post">
	                        <div class="d-flex justify-content-between mb-3">
	                            <div class="input-group me-2" style="width: 15px;" hidden>
	                                ...
	                                <input type="text" name="qna_num" value="${question.qna_num }">
	                            </div>
	                            <!-- 제목 select -->
	                            ...
	                            <div class="input-group flex-grow-1 me-2">
	                                <input type="text" name="qna_title" class="form-control" placeholder="제목을 입력하세요." value="${question.qna_title}" aria-label="검색어">
	                            </div>
	                            <!-- 글쓰기 버튼 -->
	                            <div style="width: 20%;">
	                   		...
	                   		<textarea class="text1" id="text1" name="qna_content" placeholder="내용을 입력해주세요.">${question.qna_content}</textarea>
                   		</form>
                    </div>
                </div>
            </article>
    ...
    $(function() {
   		$("#noticeselect").val(${question.qna_type})
    });
	</script>
</body>
</html>
