...
<body>
    ...
    <div class="main-layout">
        ...
        <div class="content">
            <div class="title">밀키트 목록</div>
			<div><input type="button" value="추가하기" onclick="location.href='MealkitEdit'"></div>
            <!-- 카테고리 탭 -->
            <div class="category-tabs">
                <div class="category-tab active" data-target="category1" onclick="showCategory('category1')">밀키트 1</div>
                <div class="category-tab" data-target="category2" onclick="showCategory('category2')">밀키트 2</div>
                <div class="category-tab" data-target="category3" onclick="showCategory('category3')">밀키트 3</div>
                <div class="category-tab" data-target="category4" onclick="showCategory('category4')">밀키트 4</div>
            </div>
            ...
            <div class="product-container active" id="category1">
                <div class="product-card">
                    ...
                    <div class="product-name">밀키트 1 상품</div>
            ...
            <div class="product-container" id="category2">
                <div class="product-card">
                    <div class="product-image">이미지</div>
                    <div class="product-name">밀키트 2 상품</div>
            ...
            <div class="product-container" id="category3">
                <div class="product-card">
                    <div class="product-image">이미지</div>
                    <div class="product-name">밀키트 3 상품</div>
            ...
            <div class="product-container" id="category4">
                <div class="product-card">
                    <div class="product-image">이미지</div>
                    <div class="product-name">밀키트 4 상품</div>
