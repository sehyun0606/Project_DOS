...
<body>
    ...
    <div class="container2">
        ...
        <form action="AdminNoticeEdit?board_num=${notice.board_num}" method="post">
            <!-- 제목 입력 -->
            <div class="form-group">
                <label for="title">제목 작성</label>
                <input type="text" id="title" name="board_title" placeholder="공지사항 제목을 입력하세요" value="${notice.board_title}" required>
            </div>

            <!-- 내용 입력 -->
            <div class="form-group">
                <label for="content">공지사항 내용 작성</label>
                <textarea id="content" name="board_content" placeholder="공지사항 내용을 입력하세요" required>${notice.board_content}</textarea>
            </div>
