...
<body>
	...
	<article>
		<div class="card">
		    <h1>회원 정보 수정</h1>
		    <form action="SuccessModify" name="joinForm" method="post">
<!-- 		        <div class="mb-3"> -->
...
<!-- 		        </div> -->
		        <div class="mb-3 ">
		            ...
		            <div class="input-group">
		                <input type="text" class="form-control" id="id" name="member_id" value="${member.member_id }" placeholder="4~16자 영문자, 숫자, _조합"  readonly>
		            </div>
		        </div>
		        <div id="checkIdResult"></div>
		        <div class="mb-3">
		            <label for="password" class="form-label">비밀번호</label>
		            <input type="password" class="form-control" id="passwd" name="passwd" placeholder="비밀번호를 변경시 입력하세요"  >
		        </div>
		        <div id="checkPasswdResult"></div>
		        <div class="mb-3">
		            <label for="confirmPassword" class="form-label">비밀번호 확인</label>
		            <input type="password" class="form-control" id="passwd2" placeholder="비밀번호를 다시 입력하세요." >
		        </div>
		        <div id="checkPasswd2Result"></div>
		        <div class="mb-3">
		            <label for="name" class="form-label">이름</label>
		            <input type="text" class="form-control" id="name" name="member_name" value="${member.member_name }" pattern="^[가-힣]{2,6}$" title="한글 2글자 ~ 6글자 사이" required>
		        </div>
		        <div class="mb-3">
		            <label for="birthdate" class="form-label">생년월일</label>
		            <input type="date" class="form-control" id="birthdate" value="${member.member_birth }" name="member_birth"  required>
		        </div>
		        <div class="mb-3">
		            <label for="phoneNumber" class="form-label">전화번호</label>
		            <input type="text" class="form-control" id="phoneNumber" name="member_phone" value="${member.member_phone }" placeholder="전화번호를 입력하세요." required>
		        </div>
		        <div class="mb-3">
		            <label for="email" class="form-label">이메일</label>
		            <input type="email" class="form-control" id="email" placeholder="이메일을 입력하세요" value="${member.member_email }" name="member_email" required>
		        </div>
		        <div class="mb-3">
			            <label for="email" class="form-label">주소</label>
						<input type="text" class="form-control" id="postcode" name="member_post_code" value="${member.member_post_code }" size="6" readonly placeholder="우편번호" required>
			            <input type="text" class="form-control" id="address1" name="member_address1" value="${member.member_address1 }" size="6" placeholder="기본주소" >
			            <input type="text" class="form-control" id="address2" name="member_address2" value="${member.member_address2 }" size="6" placeholder="상세주소" >
