...
<body>
    <div class="main-container">
    	<form action="Reservation" method="post">
	        ...
	        <div class="date-picker">
	            ...
	            <input type="date" id="date" name="reservation_date" value="${param.reservation_date}" required>
	        </div>
			<!-- 네모 박스 -->
	        <div class="box-container">
	          ...
	          <div  class="input-group">
			        <label>인원 선택:</label>
			            <div>
						    <label>
						        <input type="checkbox" name="people_count" value="1"> 1인
						    </label>
						    <label>
						        <input type="checkbox" name="people_count" value="2"> 2인
						    </label>
						    <label>
						        <input type="checkbox" name="people_count" value="3"> 3인
						    </label>
						    <label>
						        <input type="checkbox" name="people_count" value="4"> 4인
						    </label>
						    <label>
						        <input type="checkbox" name="people_count" value="5~8"> 5인~8인
						    </label>
						</div>
   ...
   <script type="text/javascript">
	   $("#date").change(function() {
	       ...
	       window.location.href = "Reservation?reservation_date=" + selectedDate;
	   });
